...
const ItemBoughtCard = ({name = 'Omaya 3330 smooth and', price = '200'}) => {
  ...
  return (
    <div className="item-bought bg-light-blue w-full my-1 md:flex md:bg-white md:justify-between md:items-center px-2 text-sm">
        ...
        <div className="top flex items-center shadow md:shadow-none bg-white p-1 pointer" onClick={() => setDropdownState(!dropdownState)}>
        ...
        <div className={`w-full md:w-max transition-all  overflow-hidden md:overflow-show shadow md:shadow-none bg-gray-100 md:bg-white md:flex ${dropdownState? 'h-max p-2' : 'h-0 p-0'} md:h-max md:p-0`}>
